...
import styles from '../PatientsView/PatientsView.css'

class PatientsViewPhysician extends Component {
  constructor(props) {
    super(props)
    this.state = {
      name: '',
...
export default connect(mapStateToProps, actions)(PatientsViewPhysician);
