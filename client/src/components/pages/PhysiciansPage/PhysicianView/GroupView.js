...
import ScriptsTab from './GroupTabs/ScriptsTab'
import AppointmentsNotesTab from './GroupTabs/AppointmentsNotesTab'
import GroupTab from './GroupTabs/GroupTab'
import UsersTab from './GroupTabs/UsersTab'
                ...
                <div className="flex-grid">
                    <div id="contactInfo" className={styles.contactInfo}>
                        {editing ? (
                            <div className="name">
                                Name:
                {this.props.pID.match.params.group}
                                <Input
                                ...
                                <div>
                                    Name: {this.props.match.params.group}
                                </div>
                            )}

                        <div>
                            Number of Physicians: {this.state.physicianNum}
                        </div>
            ...
            <div>
              ...
              /> */}
                            ...
                            <Button
                                ...
                                title="GIVE ACCESS"
                                style={{ marginLeft: 8 }}
                                link={`/physicians/groups/${this.state.group}/access`}
                            />
                        </div>
                    </h2>
                </Header>
